function [coord,etpl,fext,bc,ngp,lstps,NRitmax,NRtol,ndim,D,dxr]=C_M
ngp=8; NRitmax=50; NRtol=1e-6; ndim=5; lstps=60;
nels=8; len=12; dep=0.1; wid=1; lay=1;
...
fext( nodes*5   -0)=-25*pi/3*1/6;
fext((nodes-1)*5-0)=-25*pi/3*2/3;
fext((nodes-2)*5-0)=-25*pi/3*1/6;
